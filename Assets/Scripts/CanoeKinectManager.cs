...
public class CanoeKinectManager : MonoBehaviour
{
    ...
    // GUI Texture to display the canoe.
    ...
    public CanoeKinectManager Instance
    {
        get
        {
            return this;
    ...
    public bool IsKinectInitialized()
    {
                ...
                foreach (KinectGestures.GestureData gestureData in player1Gestures)
                {
                    ...
                    else if (gestureData.progress >= 0.1f)
                    {
                        if (gestureData.gesture == KinectGestures.Gestures.LeftHandCursor &&
                            gestureData.progress >= 0.5f && Canoe.transform.localPosition.x < 8.0f)
                        {
                            Canoe.transform.Rotate(new Vector3(0, 0, 0.1f));
                            Canoe.transform.Translate(Vector3.right * speed * Time.deltaTime);
                        }
                        else if (gestureData.gesture == KinectGestures.Gestures.RightHandCursor &&
                            gestureData.progress >= 0.5f && Canoe.transform.localPosition.x > -8.0f)
                        {
                            Canoe.transform.Rotate(new Vector3(0, 0, -0.1f));
                            Canoe.transform.Translate(-Vector3.right * speed * Time.deltaTime);
