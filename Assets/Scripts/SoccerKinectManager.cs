...
public class SoccerKinectManager : MonoBehaviour
{
    ...
    //private static SoccerKinectManager instance;
    ...
    // returns the single SoccerKinectManager instance
    public SoccerKinectManager Instance
    {
        get
        {
            return this;
